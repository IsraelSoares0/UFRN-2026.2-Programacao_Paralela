...
Este relatório apresenta os resultados de dois programas em C, paralelizados com OpenMP, cujo objetivo é realizar $N$ inserções em listas encadeadas de forma concorrente, garantindo a integridade das estruturas de dados e evitando condições de corrida.
...
\subsection{Programa generalizado para $M$ listas}
